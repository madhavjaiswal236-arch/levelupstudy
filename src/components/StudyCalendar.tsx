          ...
          <div className="min-h-[80px] py-4 md:py-0 border-b border-slate-200 dark:border-white/10 flex flex-wrap items-center justify-between px-4 md:px-6 bg-white dark:bg-[#1A1A1A] gap-4 shrink-0">
            ...
            <div className="flex items-center gap-4">
              <button
                ...
                disabled={isSyncing}
                className={`timeline-button ${isSyncing ? 'is-active' : ''}`}
              >
                ...
                <div className="state state--sent">
                  <div className="icon">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" height="1.2em" width="1.2em" strokeWidth="0.5px" stroke="black">
                      <g style={{filter: 'url(#shadow)'}}>
